...
class HomeScreenViewModel @Inject constructor(
    ...
    private fun loadLocation() {
        Log.d("APARIMIT", "Entered loadLocation")
        _homeScreenState.value = ForecastUiState.Loading
        Log.d("APARIMIT", "Entered loading state")
    ...
    private suspend fun fetchForecast() {
        Log.d("APARIMIT", "Entered fetchForecast")
        when (val result = getForecastUseCase.invoke()) {
            is Result.Success -> {
                Log.d("APARIMIT", "Result is success")
